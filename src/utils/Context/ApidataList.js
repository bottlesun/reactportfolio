...
const ApidataList = (props) => {
    ...
    const PortfolioData =  [
        ...
        },
        {
            ...
            contents:'작업했던 내용들을 모아서 정리해볼 필요가 있다고 생각해 기획 했던, 홈페이지이다. 색감과 디자인 전박적인 컨셉은 2022 펜톤에서 가지고 왔으며, 홈페이지에  about 부분에서 쓴 글들에 나의 욕심이나 개발자로써의 발전 목표 등 가치관을 써둔것이 포인트이다. 리액트로 작업을 진행했으며, html , css 때와는 다르게 반복작업을 최소화 할 수있는 데이터를 불러오는 방식을 사용하여 진행했고, 리액트 훅의 사용의 중점을 둔 학습을 위해 작업한 홈페이지다. ',
